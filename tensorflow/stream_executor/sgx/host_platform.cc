...
#include "tensorflow/stream_executor/sgx/host_platform.h"
...
HostPlatform::HostPlatform() : name_("Sgx") {}

HostPlatform::~HostPlatform() {}

Platform::Id HostPlatform::id() const { return kSgxPlatformId; }
...
static void InitializeHostPlatform() {
  std::unique_ptr<Platform> platform(new sgx::HostPlatform);
...
REGISTER_MODULE_INITIALIZER(sgx_platform,
                            stream_executor::sgx::InitializeHostPlatform());

// Note that module initialization sequencing is not supported in the
// open-source project, so this will be a no-op there.
REGISTER_MODULE_INITIALIZER_SEQUENCE(sgx_platform, multi_platform_manager);
