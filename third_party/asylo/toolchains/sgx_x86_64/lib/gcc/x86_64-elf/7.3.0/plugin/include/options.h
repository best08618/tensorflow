...
enum opt_code
{
  ...
  OPT_mfunction_return_ = 1211,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1212, */              /* -mfused-madd */
  OPT_mfxsr = 1213,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1214,             /* -mgeneral-regs-only */
  OPT_mhard_float = 1215,                    /* -mhard-float */
  OPT_mhle = 1216,                           /* -mhle */
  OPT_miamcu = 1217,                         /* -miamcu */
  OPT_mieee_fp = 1218,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1219,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1220,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1221,              /* -mindirect-branch= */
  ...
  OPT_mpku = 1252,                           /* -mpku */
  OPT_mpopcnt = 1253,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1254,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1255,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1256,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1257,                        /* -mprfchw */
  OPT_mpush_args = 1258,                     /* -mpush-args */
  OPT_mrdpid = 1259,                         /* -mrdpid */
  OPT_mrdrnd = 1260,                         /* -mrdrnd */
  OPT_mrdseed = 1261,                        /* -mrdseed */
  OPT_mrecip = 1262,                         /* -mrecip */
  OPT_mrecip_ = 1263,                        /* -mrecip= */
  OPT_mrecord_mcount = 1264,                 /* -mrecord-mcount */
  OPT_mred_zone = 1265,                      /* -mred-zone */
  OPT_mregparm_ = 1266,                      /* -mregparm= */
  OPT_mrtd = 1267,                           /* -mrtd */
  OPT_mrtm = 1268,                           /* -mrtm */
  OPT_msahf = 1269,                          /* -msahf */
  OPT_msgx = 1270,                           /* -msgx */
  OPT_msha = 1271,                           /* -msha */
  OPT_mskip_rax_setup = 1272,                /* -mskip-rax-setup */
  OPT_msoft_float = 1273,                    /* -msoft-float */
  OPT_msse = 1274,                           /* -msse */
  OPT_msse2 = 1275,                          /* -msse2 */
  OPT_msse2avx = 1276,                       /* -msse2avx */
  OPT_msse3 = 1277,                          /* -msse3 */
  OPT_msse4 = 1278,                          /* -msse4 */
  OPT_msse4_1 = 1279,                        /* -msse4.1 */
  OPT_msse4_2 = 1280,                        /* -msse4.2 */
  OPT_msse4a = 1281,                         /* -msse4a */
  /* OPT_msse5 = 1282, */                    /* -msse5 */
  OPT_msseregparm = 1283,                    /* -msseregparm */
  OPT_mssse3 = 1284,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1285,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1286,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1287,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1288,            /* -mstringop-strategy= */
  OPT_mstv = 1289,                           /* -mstv */
  OPT_mtbm = 1290,                           /* -mtbm */
  OPT_mtls_dialect_ = 1291,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1292,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1293,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1294,                         /* -mtune= */
  OPT_mveclibabi_ = 1295,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1296,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1297,                    /* -mvzeroupper */
  OPT_mx32 = 1298,                           /* -mx32 */
  OPT_mxop = 1299,                           /* -mxop */
  OPT_mxsave = 1300,                         /* -mxsave */
  OPT_mxsavec = 1301,                        /* -mxsavec */
  OPT_mxsaveopt = 1302,                      /* -mxsaveopt */
  OPT_mxsaves = 1303,                        /* -mxsaves */
  OPT_n = 1304,                              /* -n */
  OPT_no_canonical_prefixes = 1305,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1306,              /* -no-integrated-cpp */
  OPT_no_pie = 1307,                         /* -no-pie */
  OPT_nocpp = 1308,                          /* -nocpp */
  OPT_nodefaultlibs = 1309,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1310,                   /* -nostartfiles */
  OPT_nostdinc = 1311,                       /* -nostdinc */
  OPT_nostdinc__ = 1312,                     /* -nostdinc++ */
  OPT_nostdlib = 1313,                       /* -nostdlib */
  OPT_o = 1314,                              /* -o */
  OPT_p = 1315,                              /* -p */
  OPT_pass_exit_codes = 1316,                /* -pass-exit-codes */
  /* OPT_pedantic = 1317, */                 /* -pedantic */
  OPT_pedantic_errors = 1318,                /* -pedantic-errors */
  OPT_pg = 1319,                             /* -pg */
  OPT_pie = 1320,                            /* -pie */
  OPT_pipe = 1321,                           /* -pipe */
  OPT_posix = 1322,                          /* -posix */
  OPT_print_file_name_ = 1323,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1324,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1325,          /* -print-multi-directory */
  OPT_print_multi_lib = 1326,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1327,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1328,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1329,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1330,               /* -print-prog-name= */
  OPT_print_search_dirs = 1331,              /* -print-search-dirs */
  OPT_print_sysroot = 1332,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1333,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1334,                        /* -profile */
  OPT_pthread = 1335,                        /* -pthread */
  OPT_quiet = 1336,                          /* -quiet */
  OPT_r = 1337,                              /* -r */
  OPT_rdynamic = 1338,                       /* -rdynamic */
  OPT_remap = 1339,                          /* -remap */
  OPT_s = 1340,                              /* -s */
  OPT_save_temps = 1341,                     /* -save-temps */
  OPT_save_temps_ = 1342,                    /* -save-temps= */
  OPT_shared = 1343,                         /* -shared */
  OPT_shared_libgcc = 1344,                  /* -shared-libgcc */
  ...
  /* OPT_std_c1x = 1367, */                  /* -std=c1x */
  /* OPT_std_c89 = 1368, */                  /* -std=c89 */
  OPT_std_c90 = 1369,                        /* -std=c90 */
  OPT_std_c99 = 1370,                        /* -std=c99 */
  /* OPT_std_c9x = 1371, */                  /* -std=c9x */
  OPT_std_f2003 = 1372,                      /* -std=f2003 */
  OPT_std_f2008 = 1373,                      /* -std=f2008 */
  OPT_std_f2008ts = 1374,                    /* -std=f2008ts */
  OPT_std_f95 = 1375,                        /* -std=f95 */
  OPT_std_gnu = 1376,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1377, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1378, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1379,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1380,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1381, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1382, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1383,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1384,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1385,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1386, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1387, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1388,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1389,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1390, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1391, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1392,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1393, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1394, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1395, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1396,                     /* -std=legacy */
  OPT_symbolic = 1397,                       /* -symbolic */
  OPT_t = 1398,                              /* -t */
  OPT_time = 1399,                           /* -time */
  OPT_time_ = 1400,                          /* -time= */
